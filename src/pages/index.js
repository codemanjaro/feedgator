...
export const HomePage = ({ data }) => {
  ...
  <div id="root" className="lh-copy mw6 center ph3">
    <header className="tc">
      ...
      <h2 className="f5 fw1">
      A minimalistic Gatsby blog rendering your Future Dream Job!<br/> Most of the job list a Remote due to pandemic & for more resource visit <a href={'https://www.cosmotory.xyz'}>Cosmotory</a>
      </h2>   
    </header>
